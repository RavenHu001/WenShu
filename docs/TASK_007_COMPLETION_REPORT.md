...
| 文档     | `docs/TASK_007_WP0_REPORT.md`、本报告；README、PROJECT_BASELINE、TESTING、任务文档同步                                                                                                                                                                                                                                                      |
...
下一任务建议为"工作区 DOCX 正文搜索与结果定位"：复用 Task 6 已验证的搜索请求、取消、
预算、统计和过期结果原则，为 DOCX 单独设计纯文本提取、段落位置映射、结果 revision 与
富文本编辑器定位；在 Task 7 完成前不把 DOCX 隐式加入 TXT 搜索器。
