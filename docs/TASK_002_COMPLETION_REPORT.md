...
| 打开多层目录文件夹 | 待手工 | 需人工操作 GUI                          |
| 展开和折叠多层目录 | 待手工 | 需人工操作 GUI                          |
| 打开空文件夹       | 待手工 | 需人工操作 GUI                          |
| 取消目录选择       | 待手工 | 需人工操作 GUI                          |
| 切换工作区         | 待手工 | 需人工操作 GUI                          |
| 外部修改后刷新     | 待手工 | 需人工操作 GUI                          |
| 点击文件不读取正文 | 待手工 | 需人工操作 GUI                          |
| 控制台无未处理异常 | 待手工 | 需人工检查 DevTools                     |
