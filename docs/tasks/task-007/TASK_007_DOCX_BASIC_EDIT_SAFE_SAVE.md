...
简体中文 | [English](./TASK_007_DOCX_BASIC_EDIT_SAFE_SAVE.en.md)
...
- 前置任务：[TASK-006：工作区 TXT 搜索与当前文件查找替换](../task-006/TASK_006_TXT_SEARCH_FIND_REPLACE.md)
- 前置完成报告：[TASK-006 完成报告](../task-006/TASK_006_COMPLETION_REPORT.md)
...
- `docs/tasks/task-006/TASK_006_TXT_SEARCH_FIND_REPLACE.md` 与完成报告；
- `src/main/index.ts`；
...
Task 7 完成后的下一任务已规划为 [TASK-008：工作区 DOCX 正文搜索与富文本结果定位](../task-008/TASK_008_DOCX_WORKSPACE_SEARCH.md)：复用 Task 6 已验证的搜索请求、取消、预算、统计和过期结果原则，但为 DOCX 单独设计规范正文投影、文本块位置映射、结果 revision 和富文本编辑器定位，不把 DOCX 当作 UTF-8 TXT 读取。
