...
简体中文 | [English](./TASK_012_DEVELOPMENT_PROMPT.en.md)
...
`docs/tasks/task-012/TASK_012_WINDOWS_ALPHA_RELEASE.md` 第 3.4 节列出的官方来源重新查证：
...
- 新增 `docs/tasks/task-012/TASK_012_COMPLETION_REPORT.md`；
...
9. `docs/tasks/task-012/TASK_012_WP0_REPORT.md` 和 `docs/tasks/task-012/TASK_012_COMPLETION_REPORT.md`；
...
先完整阅读 docs/tasks/task-012/TASK_012_DEVELOPMENT_PROMPT.md 的主提示词、docs/tasks/task-012/TASK_012_WINDOWS_ALPHA_RELEASE.md，以及其第 3.1 节的全部必读材料。检查全部适用 AGENTS.md 和 git status，保留用户修改。
...
新增 docs/tasks/task-012/TASK_012_WP0_REPORT.md，记录官方链接、精确版本、基线命令、依赖/许可证、包内容风险、Windows/CI/签名决策、测试计划、已知阻塞和 WP0 是否通过。结束时审查 diff、运行文档格式检查，报告是否可进入 WP1。不要进入 WP1。
```
