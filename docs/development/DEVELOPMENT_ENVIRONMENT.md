...
简体中文 | [English](./DEVELOPMENT_ENVIRONMENT.en.md)
...
Task 4 的 WP0 将这些项目作为首次写入能力实施前的强制门禁，详见 [TASK-004 规划](../tasks/task-004/TASK_004_TXT_EDIT_SAFE_SAVE.md)。
...
后续实机验证边界、远程 CI 和已知限制以 [TASK-012 完成报告](../tasks/task-012/TASK_012_COMPLETION_REPORT.md) 为准。
