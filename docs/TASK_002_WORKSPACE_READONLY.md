...
- 后续直接任务：[TASK-003：UTF-8 TXT 受控读取与单只读标签页](./TASK_003_TXT_READONLY.md)
...
Task 2 完成后，下一任务为 [TASK-003：UTF-8 TXT 受控读取与单只读标签页](./TASK_003_TXT_READONLY.md)：从只读文件树选择一个 UTF-8 TXT 文件，通过新的受控 IPC 读取正文，并在中央区域的单个只读标签页中显示。
