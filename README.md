...
> **当前阶段：Pre-alpha / 工作区与文件树。** Task 1、Task 2 已完成；应用具备完整的工作区选择、只读文件树浏览和可展开/折叠的目录结构。Task 3 的开发规划已就绪，TXT 正文读取尚未实现。
...
- [ ] [Task 3：UTF-8 TXT 受控读取与单只读标签页](./docs/TASK_003_TXT_READONLY.md)（规划完成，待开发）；
- [ ] TXT 基础编辑与安全保存；
- [ ] 多标签页与工作区搜索；
- [ ] 基础 DOCX 阅读、编辑和安全保存。
